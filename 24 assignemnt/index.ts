...
console.log("inequality with strings","car "as string != "CAR");

//• Tests using the lower case function
console.log(" lower case function","RAMESHA".toLowerCase ()== "ramesha");
//• Numerical tests involving equality and inequality
console.log(" tests involving  inequality", 12  as number !== 20);
...
//• Numerical tests involving equality and inequality
console.log(" tests involving  inequality", 12  as number !== 12);
//greater than
...
let guest_name :string [] =["hira","saba","maha","areeba"];
