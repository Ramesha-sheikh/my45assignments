...
function make_great(magicians: string[]): string[] {
    let modifiedMagicians: string[] = []; // Create a new array to store modified magician names
...
let greatMagicians: string[] = make_great([...magicians]); // Use spread operator to create a copy of the array
